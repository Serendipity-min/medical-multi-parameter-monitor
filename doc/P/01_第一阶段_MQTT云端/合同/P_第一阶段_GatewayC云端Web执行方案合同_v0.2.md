...
> **状态**：已执行的历史合同；授权与验收边界仍按 2026-09-20 原文解释，不以本块回写当时任务。
> **历史实现**：STM32F407 裸机 + Hardened Paho Embedded C + MQTT 3.1.1。
> **后续安全治理**：见 [P4.1 安全治理收尾分析报告](../../90_维护/P4.1_安全治理收尾分析报告.md)及同目录安全门记录。
> **后续平台迁移**：P5/P6 的 coreMQTT/FreeRTOS 仅为未来路线，见 [迁移 ADR](../../90_维护/ADR_Gateway_MQTT客户端与FreeRTOS迁移路线_v0.1.md)；尚非本合同实现。
> **当前集成基线**：见 [P 文档导航](../../README.md)，勿将下文开发分支当作现行 P4。
