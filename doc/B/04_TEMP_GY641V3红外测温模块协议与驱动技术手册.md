...
| **Byte 1 ~ 2** | **物表目标温度 (To)** | `int16_le` | `To (℃) = (Byte 1 * 256 + Byte 2) / 100.0` | 额头皮肤表面辐射温度（通常 31.0～34.5 ℃） |
| **Byte 3 ~ 4** | **环境基准温度 (Ta)** | `int16_le` | `Ta (℃) = (Byte 3 * 256 + Byte 4) / 100.0` | 室温/芯片本体温度（通常 15.0～35.0 ℃） |
| **Byte 5 ~ 6** | **人体补偿体温 (Bo)** | `int16_le` | `Bo (℃) = (Byte 5 * 256 + Byte 6) / 100.0` | **医用额温换算体温**（正常范围 36.0～37.3 ℃） |
